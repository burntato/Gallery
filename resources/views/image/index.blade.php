                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a class="btn btn-icon icon-left btn-primary" href="{{ route('image.create') }}">Upload New
                                    Image</a>
                        ...
                        <div class="card-body">
                            ...
                            <div class="show-search mb-3" style="display: none">
                                <form id="search" method="GET" action="{{ route('image.index') }}">
                                    <div class="form-row">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <a class="btn btn-secondary" href="{{ route('image.index') }}">Reset</a>
                                    </div>
                                </form>
                            </div>
